...
export type RegularUserFragment = { __typename?: 'User', channelId: string, email: string, id: string, name: string };
...
export type LoginUserMutation = { __typename?: 'Mutation', loginUser: { __typename?: 'User', channelId: string, email: string, id: string, name: string } };
...
export type RegisterUserMutation = { __typename?: 'Mutation', registerUser: { __typename?: 'User', channelId: string, email: string, id: string, name: string } };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', channelId: string, email: string, id: string, name: string } | null };
...
export type UserQuery = { __typename?: 'Query', user?: { __typename?: 'User', channelId: string, email: string, id: string, name: string } | null };
...
export const UserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"User"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"channelId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"channelId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"channelId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"RegularUser"}}]}}]}},...RegularUserFragmentDoc.definitions]} as unknown as DocumentNode<UserQuery, UserQueryVariables>;
...
export type GraphCacheResolvers = {
  ...
  User?: {
    channelId?: GraphCacheResolver<WithTypename<User>, Record<string, never>, Scalars['ID'] | string>,
